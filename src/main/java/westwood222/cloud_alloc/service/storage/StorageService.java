...
public abstract class StorageService implements Comparable<StorageService> {
    ...
    public static StorageService createInstance(@Nonnull Long freeSpace) {
        return new StorageService(null, freeSpace) {
            ...
            @Override
            public StorageDeleteResponse delete(StorageDeleteRequest request) throws ExternalException {
                return null;
            }
        };
    }
     ...
     */
    public abstract StorageUploadResponse upload(StorageUploadRequest request) throws ExternalException;
     ...
     */
    public abstract StorageReadResponse read(StorageReadRequest request) throws ExternalException;
     ...
     * @throws ExternalException when something went wrong during reading the file
     */
    public abstract StorageDeleteResponse delete(StorageDeleteRequest request) throws ExternalException;
